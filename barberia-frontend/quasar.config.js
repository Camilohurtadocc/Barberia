...
export default defineConfig((/* ctx */) => {
  return {
    ...
    framework: {
      config: {
        // Toda la aplicación es oscura. Sin esto, los componentes que Quasar
        // monta por su cuenta fuera del árbol de la app —los diálogos de
        // confirmación y los avisos de Notify— salían con fondo blanco, porque
        // las reglas de app.scss no alcanzan a un portal que se inyecta en
        // <body> con las clases del tema claro.
        dark: true,
